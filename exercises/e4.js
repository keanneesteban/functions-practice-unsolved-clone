...
var splitFirstAndLastNames = (str) => str.split(' ');
...
var personAge = (personObject) => (personObject.age);
...
var isNameInArray = (arr, name) => arr.includes(name);
